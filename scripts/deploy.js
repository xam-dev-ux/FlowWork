...
async function main() {
  ...
  const FlowWorkMarket = await hre.ethers.getContractFactory("FlowWorkMarket");
  ...
  console.log("Min Agent Stake:", hre.ethers.formatUnits(await flowWork.MIN_AGENT_STAKE(), 6), "USDC");
